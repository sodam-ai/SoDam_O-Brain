...
![그래프 뷰](assets/screenshots/graph-2d.png)

**개요 탭 — 통계·분포**
![개요 탭](assets/screenshots/overview.png)

**목록 탭 — 카드 목록 + 상세 패널**
![목록 탭](assets/screenshots/list-detail.png)

**타임라인 탭 — 시간순 기억**
![타임라인 탭](assets/screenshots/timeline.png)

**설정 탭 — 5개 조절 항목**
![설정 탭](assets/screenshots/settings.png)
